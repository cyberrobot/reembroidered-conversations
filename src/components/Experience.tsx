...
export const Experience: React.FC = () => {
  return (
    <section
      id="the-experience"
      className="py-20 md:py-28 bg-[#F5EFE9]/60 relative"
    >
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="max-w-2xl mx-auto text-center mb-16">
          ...
          <p className="font-sans text-[#68635F] text-base sm:text-lg leading-relaxed font-light">
            You don't need to perform, explain yourself perfectly, or arrive
            with a goal. Here is what makes these 55 minutes different from
            everyday life.
          </p>
        </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-sm text-[#4B4643] font-sans">
              <div className="p-4 rounded-xl bg-[#F5EFE9]/50 border border-[#E8DFD5]/70 flex items-start gap-3">
                ...
                <p className="font-light">
                  ...
                  Contemplating leaving a job, a relationship, or an identity
                  that no longer fits.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-[#F5EFE9]/50 border border-[#E8DFD5]/70 flex items-start gap-3">
                ...
                <p className="font-light">
                  ...
                  Saying the messy, politically incorrect, or exhausted thoughts
              ...
              <div className="p-4 rounded-xl bg-[#F5EFE9]/50 border border-[#E8DFD5]/70 flex items-start gap-3">
                ...
                <p className="font-light">
                  ...
                  The exhaustion of holding everyone else’s emotional and
                  domestic worlds together.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-[#F5EFE9]/50 border border-[#E8DFD5]/70 flex items-start gap-3">
                ...
                <p className="font-light">
                  ...
                  A shift in health, children leaving home, an unacknowledged
                  ending, or an unfulfilled longing.
                </p>
              </div>
            </div>
