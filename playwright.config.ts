...
export default defineConfig({
  ...
  webServer: externalBaseUrl ? undefined : {
    ...
    env: {
      ...
      BOOKING_MANAGEMENT_SECRET: process.env.BOOKING_MANAGEMENT_SECRET ?? managementTestSecret,
      BOOKING_CHANGES_URL: process.env.BOOKING_CHANGES_URL ?? 'http://127.0.0.1:3000/booking/manage',
