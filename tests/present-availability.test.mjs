...
test("presents available days with timezone-aware dates, AM/PM times, and periods", () => {
  const days = presentAvailability({
    ...
    days: [
      { date: "2035-01-09", slots: [] },
      {
        ...
        slots: [
          {
            startAt: "2035-07-10T08:30:00.000Z",
            endAt: "2035-07-10T09:25:00.000Z",
          },
          {
            startAt: "2035-07-10T12:00:00.000Z",
            endAt: "2035-07-10T12:55:00.000Z",
          },
          {
            startAt: "2035-07-10T16:00:00.000Z",
            endAt: "2035-07-10T16:55:00.000Z",
          },
        ],
      },
    ],
  ...
  assert.deepEqual(
    days[0].slots.map(({ time, period }) => ({ time, period })),
    [
