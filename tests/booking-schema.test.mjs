...
test(
  ...
  async () => {
    ...
    try {
      ...
      await client.query('UPDATE bookings SET status = \'REFUNDED\' WHERE id = $1', [
      ...
      for (const [field, constraint, day] of [
        ['stripeCheckoutSessionId', 'bookings_stripe_checkout_session_id_key', '07'],
        ['stripePaymentIntentId', 'bookings_stripe_payment_intent_id_key', '08'],
